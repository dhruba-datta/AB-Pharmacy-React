  ...
  return (
    <div className="App">
      ...
      <div className="category-buttons">
        <button onClick={() => setCurrentCategory("general")}>General</button>
        <button onClick={() => setCurrentCategory("popular")}>Popular</button>
        <button onClick={() => setCurrentCategory("herbal")}>Herbal</button>
        <button onClick={() => setCurrentCategory("surgical")}>Surgical</button>
        <button onClick={() => setCurrentCategory("baby_food")}>
          Baby Food
        </button>
        <button onClick={() => setCurrentCategory("others")}>Others</button>
      </div>
      {loading ? (
        <p>Loading...</p>
      ) : (
